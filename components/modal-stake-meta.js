...
const ModalStakeMeta = ({isStake = true, className = '', show = false, onClose = () => {}, ...props}) => {
    const { getBalance, smgTokenPrice,getPoolInfo,getUserInfoMetaverse,getBalanceSMG,depositMeta,withdraw2,emergencyWithdraw,getBalanceLP,getUserInfo,getUserInfoLP,deposit2,depositLp} = useContracts()
    ...
    return (
        ...
        <div className="text-center text-desc mb-2" style={{"color":"red", "fontSize":"18px"}}>You have { timeRemaining(1645974000)} remaining lock period</div>
