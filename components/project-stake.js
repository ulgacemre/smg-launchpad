...
import ModalStake from './modal-stake-project';
import ModalUnStake from './modal-unstake-project';

const _ = require('lodash');

const ProjectStake = ({data}) => {

    const router = useRouter()
    const { address } = router.query 
    const { connected,wallet,walletAddress, chainId, switchNetwork, handleConnect, waitForTransaction } = useWeb3()    
    const { getTotalStaked2, compound,getPoolInfo,claim,getUserInfo, getTokenPerBlock,getRewardPerYear,approveNewStake,approveDeuxStake, getPending, smgTokenPrice } = useContracts()


    const [contract, setContract] = useState(new Contract("0xCE7c2beED376FDC24fC67B2398bF60FDc3310fe4", abis.Smaugs))  
    ...
    const handleApprove = async () => {
        ...
        approveDeuxStake(address,MIN_APPROVE).then(async (result) => {
        ...
        <div className="section-top">
            ...
            <div className="section section-farm-panel text-white">
                <div className="container py-8 px-6 py-16">
                    ...
                    <h2 className="text-center mb-2">Deuxpad Pool </h2>
                       ...
                       <h2 className="text-center mt-3">30 days lockup pool </h2>
                        ...
                        <div className="offset-md-4 offset-lg-4 col-md-6 col-lg-4 col-12 text-center mt-8">
                            <div className="v-sheet v-sheet--outlined theme--dark rounded-xl p-3"
                                ...
                                <h4 className="text-center">DEUX</h4>
                                <div className="p-2">
                                    ...
                                    <div className="d-flex justify-space-between">
                                        ...
                                        <div>{utils.commify(totalStaked)} DEUX</div>
                                    </div>
                                    <div className="d-flex justify-space-between">
                                        <div>Total value</div>
                                    ...
                                    <div className="d-flex justify-space-between align-center pt-2" style={{'color': '#fff'}}>
                                        <div>
                                            <a href="http://bit.ly/32nkj0P" target="_blank">
                                                Buy DEUX <FontAwesomeIcon icon='external-link-alt' className="ml-1 mb-1" style={{width: '16px'}}/>
                                            </a>
                                        </div>
                                        <div>
